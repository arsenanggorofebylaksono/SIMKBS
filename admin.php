...
<div class="content-wrapper">
    ...
    }else if (isset($_GET['views']) && $_GET['views'] == "data_klasifikasi_umur") {
            include 'views/pages/klasifikasi/umur.php';
    }else if (isset($_GET['views']) && $_GET['views'] == "data_klasifikasi_pekerjaan") {
        include 'views/pages/klasifikasi/pekerjaan.php';
    }else if (isset($_GET['views']) && $_GET['views'] == "data_klasifikasi_jenis_bantuan") {
        include 'views/pages/klasifikasi/jenis_bantuan.php';
    }else if (isset($_GET['views']) && $_GET['views'] == "data_klasifikasi_penerima_bantuan") {
        include 'views/pages/klasifikasi/penerima_bantuan.php';
    }
    else {
        include 'views/pages/dashboard.php';
    }
